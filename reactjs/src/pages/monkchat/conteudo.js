...
export default function Conteudo() {
    ...
    let usuarioLog = lerUsuarioLogado(navigation);

    const [chat, setChat] = useState([]);
    const [sala, setSala] = useState('');
    const [usu, setUsu] = useState(usuarioLog.nm_usuario);
                ...
                <div className="chat">
                    {chat.map(x =>
                        <div key={x.id_chat}>
                            ...
                            <div> <img onClick={() => remover(x.id_chat)} src="public/assets/images/delete.png" alt="" style={{cursor: 'pointer'}}/></div>
